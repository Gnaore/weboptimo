...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public adminMain: AdminMainComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService) {
    ...
    itemClick(event: Event) {
        ...
        if (this.item.items) {
            ...
            // hide overlay menus
            if (this.adminMain.overlay || !this.adminMain.isDesktop()) {
                this.adminMain.sidebarActive = false;
            }
        }
    }
