...
@Component({
    selector: 'app-config',
    template: `
        <div class="layout-config" [ngClass]="{'layout-config-active': adminMain.configActive}" (click)="adminMain.onConfigClick($event)">
            ...
            <div class="layout-config-content">
                ...
                <h5>Ripple Effect</h5>
                <p-inputSwitch [ngModel]="app.ripple" (onChange)="adminMain.onRippleChange($event)"></p-inputSwitch>
...
export class AppConfigComponent implements OnInit {
    ...
    constructor(public app: AppComponent, public adminMain: AdminMainComponent) {
    }
    ...
    onConfigButtonClick(event) {
        this.adminMain.configActive = !this.adminMain.configActive;
        event.preventDefault();
    }

    onConfigCloseClick(event) {
        this.adminMain.configActive = false;
        event.preventDefault();
    }
}
